    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright ©2023 Developed by Dhareene RK</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/myphoto.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph1{
            background-image: url(/static/images/photo1.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .manph2{
            background-image: url(/static/images/photo3.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>DHAREENE RK</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>NANDHA KUMAR</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>SUDHAKAR</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>RAM</h2></b></p></div>
                    <div class="amph2"></div>
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright ©2023 Developed by DhareeneRK</footer></div>
            </div>
        </div>
    </body>
</html>
